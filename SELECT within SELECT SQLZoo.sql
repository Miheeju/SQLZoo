/* My answers to the exercises found on SQLZOO:
...
/* Out of curiosity, which country in Europe has highest GDP? */
SELECT name
FROM world
WHERE continent = 'Europe' AND
gdp >= ALL(
...
/* Solutions for 9* from https://github.com/Chenzilla/SQL_Zoo/blob/master/4_soutions.sql */
...
/* The 3x part must go inside ALL(SELECT()).*/